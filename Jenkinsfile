    ...
    stages {
        ...
        stage('Upload to EC2') {
            steps {
                ...
                sh '''
                scp -i C:/Users/Lenovo/Downloads/honors.pem C:/Users/Lenovo/.jenkins/workspace/H_SMS/target/student-0.0.1-SNAPSHOT.jar ubuntu@13.61.13.30:/home/ubuntu/student-0.0.1-SNAPSHOT.jar
                '''
            }
        }
